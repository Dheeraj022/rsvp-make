    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 py-2">
                <div>
                    <h2 className="text-3xl font-bold text-zinc-900 tracking-tight">Hotels Dashboard</h2>
                    <p className="text-zinc-500 mt-1">Manage all registered hotels and their event assignments.</p>
                </div>
                <Button
                    ...
                    <table className="w-full text-left bg-white">
                        <thead>
                            <tr className="bg-[#f8f9fa] text-zinc-700 text-[15px] font-semibold border-b border-zinc-100">
                                ...
                                <th className="px-6 py-4 w-[120px]">Action</th>
                            </tr>
                        </thead>
                                    ...
                                    return (
                                        <tr key={hotel.id} className="hover:bg-zinc-50/50 transition-colors group">
                                            <td className="px-6 py-5">
                                                <div className="font-semibold text-zinc-900">{hotel.name}</div>
                                                <div className="text-xs text-zinc-500">{hotel.manager_name} (Manager)</div>
                                            </td>
                                            <td className="px-6 py-5">
                                                {isEditing ? (
                                                    <select
                                            ...
                                            <td className="px-6 py-5">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${status === "Assigned"
