                                                                            ...
                                                                            <div className="pt-2 mt-2 border-t border-blue-100/50 dark:border-blue-900/10">
                                                                                ...
                                                                                {person.departure_details?.arrival?.driver?.name && (
                                                                                    <button
                                                                                        ...
                                                                                        className="w-full mt-2 py-1.5 rounded-lg bg-[#25D366] hover:bg-[#128C7E] text-white font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-1 transition-colors border border-[#128C7E]"
                                                                                    >
